...
//        TODO: put a marker to location that the user selected
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        val latitue = 33.217075620010085
        val longitude = -96.94364354120489
        val zoomLevel = 10f

        val homeLatLng = LatLng(latitue, longitude)
    ...
    private fun setMapStyle(map: GoogleMap) {
        try {
            ...
            Timber.e("Can't find style. Error: %s", e.localizedMessage)
        }
    }
